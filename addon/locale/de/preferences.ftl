...
auto-recognize-imported-pdf =
    .label = Metadaten für eigenständig importierte PDFs vor dem Umbenennen/Verschieben automatisch abrufen
...
remove-diacritics =
    .label = Diakritische Zeichen aus Dateinamen entfernen
